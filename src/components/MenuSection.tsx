  ...
  return (
    <section id={section.id} className="mb-8 md:mb-12">
      <div className="mb-6 md:mb-8">
        <h2 className="font-creepster text-3xl md:text-5xl text-orange-500 mb-2 flex items-center gap-2 md:gap-3">
          {Icon && <Icon className="w-8 h-8 md:w-10 md:h-10" />}
          {section.title}
        </h2>
        <div className="h-1 w-24 md:w-32 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full"></div>
      </div>
